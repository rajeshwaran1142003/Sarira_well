...
const Recipes = () => {
  const recipes = [
    {
      title: "Classic Fig Malt Latte",
      description: "An elegant twist on the traditional Tamil wellness drink with layered presentation",
      time: "8 mins",
      serves: "1",
      image: "🥛",
      ingredients: ["2 tbsp SARIRA Fig Malt", "1 cup warm milk", "1 tsp honey", "Cinnamon stick", "Fresh fig slices"]
    },
    {
